		...
		<script type="text/html" id="tmpl-mkb-attachment-item">
			<div class="mkb-article-attachments__item js-mkb-attachment-item">
				...
				<div class="mkb-article-attachments__item-actions">
					<a class="mkb-article-attachments__item-edit js-mkb-attachment-edit mkb-unstyled-link"
					   title="<?php esc_attr_e(__( 'Edit', 'minerva-kb' )); ?>" href="#">
						<i class="fa fa-folder-open"></i>
					</a>
					<a class="mkb-article-attachments__item-remove js-mkb-attachment-remove mkb-unstyled-link"
					   title="<?php esc_attr_e(__( 'Delete', 'minerva-kb' )); ?>" href="#">
						<i class="fa fa-close"></i>
					</a>
				</div>
			</div>
