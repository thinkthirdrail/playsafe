...
add_action( 'init', function() {
  ...
  if ( apply_filters( 'vc_acf_field_picker_enqueue_google_maps', get_field( 'wp_acf_vc_bridge_enqueue_google_maps', 'option' ) === 'yes' ? true : false ) ) {
...
function vc_acf_field_picker_enqueue_google_map_assets() {
  ...
  if ( acf_get_setting( 'enqueue_google_maps' ) ) {
    ...
    wp_enqueue_script( 'vc-acf-field-picker-google-map-api', 'https://maps.googleapis.com/maps/api/js?key=' . $google_api_key, array(), null, true );
  }
